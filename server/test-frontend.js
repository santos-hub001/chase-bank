...
(async () => {
  ...
  console.log('6. Fill and submit signup');
  doc.querySelector('#suName').value = 'ADAEZE OBI';
  doc.querySelector('#suEmail').value = 'adaeze@chasebank.test';
  doc.querySelector('#suPhone').value = '08123456789';
  pw.value = 'chase123';
  doc.querySelector('#suConfirm').value = 'chase123';
  doc.querySelector('#suPin').value = '2468';
  doc.querySelector('#suConfirmPin').value = '2468';
  doc.querySelector('#suBtn').click();
  await sleep(1500);
  ...
  check('avatar shows initials', doc.querySelector('.avatar')?.textContent === 'AO');
  ...
  doc.querySelector('#sendPhone').value = '08012345678';
  ...
  console.log('12. Type PIN 2468');
  const boxes = doc.querySelectorAll('.pin-box');
  boxes[0].value = '2'; boxes[0].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  boxes[1].value = '4'; boxes[1].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  boxes[2].value = '6'; boxes[2].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  ...
  b3[0].value = '2'; b3[0].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  b3[1].value = '4'; b3[1].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  b3[2].value = '6'; b3[2].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  ...
  check('account number shown', doc.body.innerHTML.includes('08123456789'));
  ...
  doc.querySelector('#loginPhone').value = '08123456789';
  ...
  wb[0].value = '2'; wb[0].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  wb[1].value = '4'; wb[1].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
  wb[2].value = '6'; wb[2].dispatchEvent(new dom.window.Event('input', { bubbles: true }));
