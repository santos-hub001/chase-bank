...
const API = {
  ...
  twofaSetup: () => api('/api/auth/2fa/setup', { method: 'POST' }),
  twofaEnable: (body) => api('/api/auth/2fa/enable', { method: 'POST', body }),
  twofaVerify: (body) => api('/api/auth/2fa/verify', { method: 'POST', body }),
  twofaDisable: (body) => api('/api/auth/2fa/disable', { method: 'POST', body }),
  twofaBackupCodes: (body) => api('/api/auth/2fa/backup-codes', { method: 'POST', body }),
